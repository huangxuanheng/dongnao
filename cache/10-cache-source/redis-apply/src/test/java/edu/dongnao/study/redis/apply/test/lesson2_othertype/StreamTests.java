...
public class StreamTests {
    ...
    public void producer() throws InterruptedException {
        RedisClient redisClient = RedisClient.create("redis://192.168.1.128:6379");
        StatefulRedisConnection<String, String> connect = redisClient.connect();
        RedisCommands<String, String> redisSyncCommands = connect.sync();
        System.out.println("往stream_sms_send中添加消息");
    ...
    public void consumer() {
        ...
        StatefulRedisConnection<String, String> connect = redisClient.connect();
        RedisCommands<String, String> redisSyncCommands = connect.sync();
        List<StreamMessage<String, String>> stream_sms_send = redisSyncCommands
        		.xread(XReadArgs.StreamOffset.from("stream_sms_send", "0"));
        for (StreamMessage<String, String> stringStringStreamMessage : stream_sms_send) {
            System.out.println("消费者读取到消息："+stringStringStreamMessage);
        }
    }
    ...
    public void createGroup() {
        ...
        RedisCommands<String, String> redisSyncCommands = connect.sync();
        // 创建分组
        System.out.println("创建分组group_1");
