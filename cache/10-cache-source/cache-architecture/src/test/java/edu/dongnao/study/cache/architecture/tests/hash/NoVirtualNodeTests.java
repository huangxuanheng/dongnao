package edu.dongnao.study.cache.architecture.tests.hash;

import edu.dongnao.study.cache.architecture.hash.ConsistentHashWithoutVirtualNode;
import edu.dongnao.study.cache.architecture.hash.ServerNode;

/**
 */
public class NoVirtualNodeTests {
    public static void main(String[] args){
        ...
        System.out.println("删除节点：192.168.0.0:111");
