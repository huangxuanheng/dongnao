...
public class HouseForm implements Serializable {
	...
	public String toString() {
		return "HouseForm [id=" + id + ", title=" + title + ", cityEnName=" + cityEnName + ", regionEnName="
				+ regionEnName + ", street=" + street + ", district=" + district + ", detailAddress=" + detailAddress
				+ ", room=" + room + ", parlour=" + parlour + ", floor=" + floor + ", totalFloor=" + totalFloor
				+ ", direction=" + direction + ", buildYear=" + buildYear + ", area=" + area + ", price=" + price
				+ ", rentWay=" + rentWay + ", subwayLineId=" + subwayLineId + ", subwayStationId=" + subwayStationId
				+ ", distanceToSubway=" + distanceToSubway + ", layoutDesc=" + layoutDesc + ", roundService="
				+ roundService + ", traffic=" + traffic + ", description=" + description + ", cover=" + cover
				+ ", tags=" + tags + ", photos=" + photos + ", adminId=" + adminId + "]";
	}
